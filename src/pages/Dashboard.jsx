                ...
                <header className="mb-12 flex flex-col md:flex-row md:items-end justify-between pb-6 border-b border-slate-200">
                    ...
                    <div className="mt-6 md:mt-0 flex items-center gap-4">
                        ...
                        <div className="flex flex-wrap gap-3">
                            <Link to="/mql" className="group flex items-center space-x-2 bg-white text-slate-700 hover:text-indigo-600 border border-slate-200 px-6 py-3 rounded-xl transition-all shadow-sm hover:shadow-md transform hover:-translate-y-0.5">
                                <PieChart className="w-4 h-4 text-slate-400 group-hover:text-indigo-500 transition-colors" />
                                <span className="font-semibold">View MQL</span>
                            </Link>
                            ...
                            <Link to="/lead-intelligence" className="group flex items-center space-x-2 bg-white text-slate-700 hover:text-indigo-600 border border-slate-200 px-6 py-3 rounded-xl transition-all shadow-sm hover:shadow-md transform hover:-translate-y-0.5">
                                <Activity className="w-4 h-4 text-slate-400 group-hover:text-indigo-500 transition-colors" />
                                <span className="font-semibold">Lead Intelligence</span>
                            </Link>
                            ...
                            <Link to="/december-overview" className="group flex items-center space-x-2 bg-white text-slate-700 hover:text-indigo-600 border border-slate-200 px-6 py-3 rounded-xl transition-all shadow-sm hover:shadow-md transform hover:-translate-y-0.5">
                                <Calendar className="w-4 h-4 text-slate-400 group-hover:text-indigo-500 transition-colors" />
                                <span className="font-semibold">December Overview</span>
                            </Link>
                            <Link to="/january-7-11-leads" className="group flex items-center space-x-2 bg-white text-slate-700 hover:text-indigo-600 border border-slate-200 px-6 py-3 rounded-xl transition-all shadow-sm hover:shadow-md transform hover:-translate-y-0.5">
                                <Calendar className="w-4 h-4 text-slate-400 group-hover:text-indigo-500 transition-colors" />
                                <span className="font-semibold">Jan 7-11 Leads</span>
                            </Link>
                            <Link to="/embedded-leads" className="group flex items-center space-x-2 bg-white text-slate-700 hover:text-indigo-600 border border-slate-200 px-6 py-3 rounded-xl transition-all shadow-sm hover:shadow-md transform hover:-translate-y-0.5">
                                <Calendar className="w-4 h-4 text-slate-400 group-hover:text-indigo-500 transition-colors" />
                            ...
                            <Link to="/aurora-labs-2" className="group flex items-center space-x-2 bg-white text-slate-700 hover:text-indigo-600 border border-slate-200 px-6 py-3 rounded-xl transition-all shadow-sm hover:shadow-md transform hover:-translate-y-0.5">
                                <Activity className="w-4 h-4 text-slate-400 group-hover:text-indigo-500 transition-colors" />
                                <span className="font-semibold">Auroralabswebsite 2</span>
                            </Link>
                            ...
                            <Link to="/loci-flags" className="group flex items-center space-x-2 bg-white text-slate-700 hover:text-indigo-600 border border-slate-200 px-6 py-3 rounded-xl transition-all shadow-sm hover:shadow-md transform hover:-translate-y-0.5">
                                <Flag className="w-4 h-4 text-slate-400 group-hover:text-indigo-500 transition-colors" />
                                <span className="font-semibold">Loci Flags</span>
                            </Link>
                            <Link to="/loci-works" className="group flex items-center space-x-2 bg-white text-slate-700 hover:text-indigo-600 border border-slate-200 px-6 py-3 rounded-xl transition-all shadow-sm hover:shadow-md transform hover:-translate-y-0.5">
                                <Activity className="w-4 h-4 text-slate-400 group-hover:text-indigo-500 transition-colors" />
                                <span className="font-semibold">How Loci Works</span>
                            </Link>
                            <Link to="/january-marketing-leads" className="group flex items-center space-x-2 bg-white text-slate-700 hover:text-indigo-600 border border-slate-200 px-6 py-3 rounded-xl transition-all shadow-sm hover:shadow-md transform hover:-translate-y-0.5">
                                <TrendingUp className="w-4 h-4 text-slate-400 group-hover:text-indigo-500 transition-colors" />
                                <span className="font-semibold">January Marketing Leads</span>
                            </Link>
                        </div>
                    </div>
                </header>
